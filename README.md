...
Have a look in the scripts folder for examples of how to use NorthNet (there is a walkthrough iPython notebook in `scripts/NetworkGenerationNotebook.ipynb`).
