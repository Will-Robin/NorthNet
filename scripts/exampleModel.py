...
def model_function(time, S, k):
    ...
    P[0] = (
        +F_in[0, i] - k[0] * S[0] * S[1] - k[1] * S[0] * S[3] - S[0] * total_flow[0, i]
    )
    P[1] = (
        +k[1] * S[0] * S[3]
        - k[0] * S[0] * S[1]
    ...
    P[3] = (
        +k[1] * S[0] * S[3] + F_in[1, i] - k[1] * S[0] * S[3] - S[3] * total_flow[0, i]
    )
    P[4] = (
        +k[4] * S[7] * S[1]
        - k[2] * S[4] * S[1]
    ...
    P[7] = (
        +k[4] * S[7] * S[1] + F_in[2, i] - k[4] * S[7] * S[1] - S[7] * total_flow[0, i]
    )
    P *= time
